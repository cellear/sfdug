# SFDUG Site Build — Handoff Document for Claude Code
...
- **Drupal 10/11** (latest stable)
- **Base theme:** Fork of [Florida DrupalCamp theme](https://github.com/mherchel/fldc22)
- **Hosting:** TBD (likely Pantheon)
- **Local dev:** DDEV
...
- **FLDC theme repo:** https://github.com/mherchel/fldc22
...
3. Hosting confirmed? (Pantheon assumed)
4. Domain ready? (sfdug.org)
5. Any must-have features from FLDC to preserve?
